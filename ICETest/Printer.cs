...
namespace ICETest
{
    ...
    public interface PrinterPrx : Ice.ObjectPrx
    {
        ...
        Ice.AsyncResult<ICETest.Callback_Printer_printString> begin_printString(string s);
        Ice.AsyncResult<ICETest.Callback_Printer_printString> begin_printString(string s, _System.Collections.Generic.Dictionary<string, string> ctx__);
...
namespace ICETest
{
    ...
    public sealed class PrinterPrxHelper : Ice.ObjectPrxHelperBase, PrinterPrx
    {
        ...
        public Ice.AsyncResult<ICETest.Callback_Printer_printString> begin_printString(string s)
        {
            return begin_printString(s, null, false, null, null);
        }

        public Ice.AsyncResult<ICETest.Callback_Printer_printString> begin_printString(string s, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<ICETest.Callback_Printer_printString> begin_printString(string s, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            IceInternal.OnewayOutgoingAsync<ICETest.Callback_Printer_printString> result__ = new IceInternal.OnewayOutgoingAsync<ICETest.Callback_Printer_printString>(this, __printString_name, printString_completed__, cookie__);
            if(cb__ != null)
            {
        ...
        private void printString_completed__(ICETest.Callback_Printer_printString cb__)
        {
            if(cb__ != null)
            {
                cb__();
